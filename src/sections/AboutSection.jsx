...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto border-t border-[#ECE9DF]">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-4 sm:space-y-6">
          ...
          <p className="text-sm sm:text-base md:text-lg text-[#686C63] leading-relaxed font-sans">
          ...
          <div className="pt-4 border-t border-[#ECE9DF] flex flex-wrap gap-4 sm:gap-6 text-xs font-mono text-[#686C63]">
            <div>
        ...
        <div className="lg:col-span-5 bg-[#ECE9DF]/60 p-6 sm:p-8 rounded-3xl border border-[#ECE9DF] space-y-6 sm:space-y-8">
          {/* BUILD List */}
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2">
              {buildItems.map((item) => (
                <div key={item} className="flex items-center justify-between bg-[#F7F5EF] p-3 rounded-xl border border-[#ECE9DF] text-xs sm:text-sm font-semibold text-[#20221F]">
                  <span>{item}</span>
                  <CheckCircle2 size={16} className="text-[#8BCF5B] shrink-0" />
                </div>
              ))}
            </div>
          </div>
          ...
          {/* THINK ABOUT List */}
          <div className="space-y-3 sm:space-y-4 pt-4 border-t border-[#ECE9DF]">
            ...
            <div className="space-y-2">
              {thinkItems.map((item) => (
                <div key={item} className="flex items-center justify-between bg-[#F7F5EF] p-3 rounded-xl border border-[#ECE9DF] text-xs sm:text-sm font-semibold text-[#20221F]">
                  <span>{item}</span>
                  <span className="w-2 h-2 rounded-full bg-[#C9F36B] shrink-0" />
                </div>
              ))}
            </div>
          </div>
