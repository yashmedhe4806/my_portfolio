  ...
  return (
    <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto border-t border-[#ECE9DF]">
      <div className="max-w-3xl space-y-6 mb-16">
        ...
        <p className="text-sm md:text-base text-[#686C63] leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch max-w-5xl mx-auto">
        ...
        <div className="md:col-span-3 bg-[#ECE9DF]/60 p-6 rounded-2xl border border-[#ECE9DF] flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <span className="text-[10px] font-mono text-[#686C63] tracking-widest uppercase">01 · THE INPUT</span>
            <h3 className="text-lg font-display font-bold text-[#20221F]">REQUEST</h3>
          </div>
          <div className="bg-[#F7F5EF] p-4 rounded-xl border border-[#ECE9DF] text-xs font-mono text-[#20221F] italic">
            "Build us a website."
          </div>
        ...
        <div className="md:col-span-4 bg-[#20221F] text-[#F7F5EF] p-6 rounded-2xl border border-[#20221F] space-y-4 shadow-xl">
          ...
          <h3 className="text-lg font-display font-bold text-[#F7F5EF]">QUESTIONS ASKED</h3>
        ...
        <div className="md:col-span-3 bg-[#C9F36B] text-[#20221F] p-6 rounded-2xl border border-[#20221F] flex flex-col justify-between space-y-4 shadow-lg">
          <div className="space-y-2">
            <span className="text-[10px] font-mono text-[#20221F] tracking-widest uppercase font-bold">03 · RESULT</span>
            <h3 className="text-lg font-display font-bold text-[#20221F]">OUTCOME</h3>
          </div>
          <div className="bg-[#20221F] text-[#F7F5EF] p-4 rounded-xl text-xs font-semibold font-display">
