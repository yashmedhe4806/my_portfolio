...
export const MainIntroSection = ({ onExplore }) => {
  return (
    <section className="min-h-[85vh] pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto flex flex-col justify-between relative">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center my-auto">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-[#20221F] leading-[1.1] tracking-tight"
          >
            I build websites.{' '}
            <span className="text-[#686C63] font-normal block mt-2">
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-[#686C63] max-w-2xl leading-relaxed font-sans"
          >
          ...
          >
            <button
              ...
              className="px-6 py-3.5 bg-[#20221F] text-[#F7F5EF] font-semibold text-xs md:text-sm rounded-xl hover:bg-[#8BCF5B] hover:text-[#20221F] transition-all flex items-center gap-3 group"
              data-cursor="think"
        ...
        >
          <div className="w-full max-w-md bg-[#ECE9DF]/40 p-6 md:p-8 rounded-3xl border border-[#ECE9DF] relative overflow-hidden group">
            ...
            <CharacterBuilder className="w-full h-auto" />
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="pt-12 flex items-center gap-4 text-xs font-mono text-[#686C63]"
      >
